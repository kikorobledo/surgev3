    ...
    <div class="h-screen flex overflow-hidden bg-cool-gray-100" x-data="{ sidebarOpen: false }" @keydown.window.escape="sidebarOpen = false">
        ...
        <div class="hidden md:flex md:flex-shrink-0">
            ...
            <div class="flex flex-col w-64 border-r border-gray-200 bg-indigo-800">
                ...
                <div class="h-0 flex-1 flex flex-col pt-5 pb-4 overflow-g:\Downloads\Cursos\Caleb Porzio\surge-master\resources\views\components\notification.blade.phpy-auto">

                    <div class="flex items-center flex-shrink-0 px-4">

                        <img class="h-10 w-auto bg-white rounded-lg mx-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="Surge Logo">
